    ...
    <div className="flex flex-col items-center p-8 bg-act-paper border-2 border-act-black shadow-[8px_8px_0px_0px_rgba(17,17,17,1)] relative overflow-hidden">
      ...
      <div className="flex justify-between w-full items-start mb-8 z-10 relative">
          <div>
            ...
            <p className="font-mono text-sm text-act-pink mt-1 font-bold">/// FIG 1.0: STATISTICAL ERASURE</p>
          </div>
          <button
             onClick={() => setView(view === 'official' ? 'reality' : 'official')}
             className="px-4 py-2 bg-act-black text-white font-mono text-sm font-bold uppercase hover:bg-act-pink hover:text-black transition-colors border-2 border-transparent"
          >
      ...
      <div className="relative w-full h-64 flex items-end justify-center gap-4 md:gap-12 border-b-4 border-act-black pb-0 z-10">
         ...
         <div className="flex flex-col items-center gap-2 w-20 md:w-24 group relative h-full justify-end">
            ...
            <span className="font-mono text-sm font-bold uppercase text-act-black text-center leading-tight">Est.<br/>Population</span>
         </div>
         ...
         <div className="flex flex-col items-center gap-2 w-20 md:w-24 relative h-full justify-end">
             ...
             />
             <span className="font-mono text-sm font-bold uppercase text-act-black text-center leading-tight">Receiving<br/>Support</span>
         </div>
         ...
         <div className="flex flex-col items-center gap-2 w-20 md:w-24 relative h-full justify-end">
             ...
             />
             <span className="font-mono text-sm font-bold uppercase text-act-black text-center leading-tight">Crisis /<br/>Custody</span>
         </div>
      </div>

      <div className="mt-8 p-4 bg-act-yellow border-2 border-act-black font-mono text-sm md:text-sm text-act-black font-bold uppercase w-full z-10">
         {view === 'official'
...
export const IntersectionalNexusDiagram: React.FC = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center relative w-full h-[450px] border-4 border-act-black bg-act-black overflow-hidden shadow-[8px_8px_0px_0px_#333]">
            ...
            <div className="absolute top-4 left-4 font-mono text-sm text-white z-20">
            ...
            <div className="relative w-full h-full flex items-center justify-center">
                ...
                <div className={`absolute z-30 w-32 h-32 rounded-full border-4 border-white flex items-center justify-center text-center bg-act-black shadow-[0_0_30px_rgba(255,255,255,0.3)]`}>
                    <div className="flex flex-col relative z-10">
                        ...
                        <span className="font-mono text-sm uppercase mt-1 text-act-yellow">Infinite Complexity</span>
                    </div>
                    {/* Radiating Energy */}
                    <motion.div
                ...
                >
                     <span className="text-act-blue font-mono text-sm font-bold absolute top-2 left-1/2 bg-black px-1">HOUSING</span>
                </motion.div>
                ...
                >
                     <span className="text-act-pink font-mono text-sm font-bold absolute bottom-4 left-1/2 bg-black px-1">JUSTICE</span>
                </motion.div>
                ...
                >
                     <span className="text-act-yellow font-mono text-sm font-bold absolute top-1/2 right-0 bg-black px-1">HEALTH</span>
                </motion.div>
  ...
  return (
    <div className="flex flex-col items-center p-8 bg-white border-2 border-act-black shadow-[8px_8px_0px_0px_#FF007F] my-8">
      <div className="w-full mb-6 border-b-2 border-act-black pb-4">
        ...
        <p className="font-mono text-sm text-stone-600 mt-2">
      ...
      <div className="relative w-full aspect-square md:h-80 bg-act-black border-2 border-act-black overflow-hidden group">
         ...
         {!imgError ? (
            ...
            >
             ...
             <div className="absolute inset-0 bg-stone-900 flex items-center justify-center">
                 <div className="text-stone-700 font-mono text-sm">NO SATELLITE DATA</div>
             </div>
         )}
         ...
         {[
             ...
             >
                 {node.central && (
                    <>
                       <div className="font-mono text-sm font-bold">CORE</div>
                 ...
                 {/* Label */}
                 {!node.central && (
                     <div className="absolute top-4 left-1/2 -translate-x-1/2 text-white font-mono text-sm font-bold tracking-widest text-shadow-sm">{node.label}</div>
                 )}
             </motion.div>
         ))}

         <div className="absolute top-4 right-4 text-right">
             <div className="text-white font-mono text-sm uppercase font-bold tracking-widest bg-black/50 px-2 py-1 backdrop-blur-sm border border-white/20">
                 Signal Strength: 100%
             </div>
         </div>
      ...
      <div className="mt-4 w-full flex justify-between font-mono text-sm uppercase font-bold">
    ...
    <div className="flex flex-col h-[500px] w-full p-8 bg-act-black border-2 border-act-black my-8 relative overflow-hidden items-center justify-between">
      ...
      <div className="w-full relative z-10 flex flex-col items-center">
         <div className="w-64 border-2 border-white bg-white text-act-black p-4 text-center shadow-[0_0_15px_rgba(255,255,255,0.2)]">
            ...
            <p className="font-mono text-sm uppercase tracking-wider mt-1">Whitehall / Policy / Scale</p>
         </div>
      ...
      <div className="relative z-20 w-80 h-32 border-2 border-act-pink bg-black/80 flex items-center justify-center p-6 backdrop-blur-sm">
         ...
         <div className="text-center">
             <div className="font-mono text-sm text-act-pink uppercase mb-1 font-bold">/// THE FULCRUM</div>
      ...
      <div className="w-full relative z-10 flex flex-col items-center justify-end">
         ...
         <div className="w-64 border-2 border-act-yellow bg-act-yellow text-act-black p-4 text-center shadow-[0_0_15px_rgba(230,255,0,0.4)]">
            ...
            <p className="font-mono text-sm uppercase tracking-wider mt-1">Community / Innovation / Survival</p>
         </div>
      </div>
    ...
    return (
        <div className="flex flex-col md:flex-row gap-8 items-start p-8 bg-white border-2 border-act-black shadow-[8px_8px_0px_0px_#111] my-8">
            <div className="flex-1">
                ...
                <p className="font-mono text-sm text-act-black mb-6 leading-relaxed border-l-2 border-act-pink pl-4">
                    /// DATA PROJECTION<br/>
                ...
                <div className="flex gap-2">
                     <button onClick={() => setScenario('urban')} className={`px-2 py-1 font-mono text-sm border-2 uppercase font-bold ${scenario === 'urban' ? 'bg-act-black text-white border-act-black' : 'bg-white text-black border-black'}`}>Urban</button>
                     <button onClick={() => setScenario('rural')} className={`px-2 py-1 font-mono text-sm border-2 uppercase font-bold ${scenario === 'rural' ? 'bg-act-black text-white border-act-black' : 'bg-white text-black border-black'}`}>Regional</button>
                </div>
            </div>
            ...
            <div className="w-full md:w-64 h-64 border-l-2 border-b-2 border-act-black flex items-end justify-around p-4 relative bg-[radial-gradient(#ddd_1px,transparent_1px)] [background-size:10px_10px]">
                ...
                <div className="w-16 group relative flex flex-col items-center justify-end h-full">
                    ...
                    />
                    <div className="mt-2 text-center font-mono text-sm uppercase font-bold">Sickness<br/>Model</div>
                </div>
                ...
                <div className="w-16 group relative flex flex-col items-center justify-end h-full">
                    ...
                    <div className="mt-2 text-center font-mono text-sm uppercase font-bold bg-act-black text-white">Prevention<br/>Model</div>
                </div>
