          ...
          <div className="flex flex-col md:flex-row gap-12 items-start">
             ...
             <div className="md:w-1/2 sticky top-24">
                 ...
                 <p className="text-lg font-sans text-white mb-8">
                     We invite policy makers, activists, health professionals, and community members into the booth to find the truths that will set us all free. Can they find a way to pass the baton, and each play their part in getting us across the line? This is where the dialogue begins.
                 </p>
                     ...
                     <div className="h-64 relative overflow-hidden grayscale contrast-125 sepia-50 group-hover:grayscale-0 transition-all duration-500">
                         ...
                         <img 
                            ...
                            onError={(e) => {
                                ...
                                e.currentTarget.src = "https://images.unsplash.com/photo-1514525253440-b393452e8d26?q=80&w=1000&auto=format&fit=crop";
                            }}
                            alt="A towering sound system speaker stack in a dimly lit club" 
                 ...
                 <div className="w-full bg-stone-900 border-2 border-stone-700 p-2 relative group cursor-pointer hover:border-act-blue transition-colors ml-4 md:ml-12" role="listitem">
                     <div className="h-48 relative overflow-hidden grayscale contrast-125 sepia-50 group-hover:grayscale-0 transition-all duration-500">
                         ...
                         <img 
                            ...
                            alt="Close up of audio mixer knobs and sliders" 
                            className="w-full h-full object-cover" 
                         />
                         <div className="absolute inset-0 bg-black/50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                             <Play size={48} className="text-white fill-current" aria-hidden="true" />
                 ...
                 <div className="w-full bg-stone-900 border-2 border-stone-700 p-2 relative group cursor-pointer hover:border-act-yellow transition-colors -ml-2 md:-ml-8" role="listitem">
                     <div className="h-48 relative overflow-hidden grayscale contrast-125 sepia-50 group-hover:grayscale-0 transition-all duration-500">
                         ...
                         <img 
                            ...
                            onError={(e) => {
                                e.currentTarget.onerror = null; 
                                e.currentTarget.src = "https://images.unsplash.com/photo-1621360841012-3f8202b8590c?q=80&w=1000&auto=format&fit=crop";
                            }}
                            alt="Tangled audio patch cables in a studio" 
                            className="w-full h-full object-cover" 
                         />
                         <div className="absolute inset-0 bg-black/50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                             <Play size={48} className="text-white fill-current" aria-hidden="true" />
